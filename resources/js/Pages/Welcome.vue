...
<template>
    <Head title="Welcome" />
    <div class="min-h-screen flex flex-col items-center bg-gray-100 justify-center">
        <div class="mb-8">
            <svg
        ...
        <div class="w-full max-w-md rounded-lg shadow-lg p-6 bg-white">
            <div class="text-center mb-6">
                <h2 class="text-xl font-medium text-gray-700">Bienvenido</h2>
